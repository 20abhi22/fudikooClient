...
class _CateringInqueryState extends State<CateringInquery> {
  ...
  final Map<String, String> _ctPlaceNames = {}; // cache for lat,lng -> place name
  ...
  Future<void> _ensurePlaceNameFor(ResponseModel? response) async {
    ...
    final lat = (enquiry?.lat?.trim().isNotEmpty == true)
        ? enquiry!.lat.trim()
        : (response.requestLat?.trim().isNotEmpty == true ? response.requestLat.trim() : '');
    final lng = (enquiry?.lng?.trim().isNotEmpty == true)
        ? enquiry!.lng.trim()
        : (response.requestLng?.trim().isNotEmpty == true ? response.requestLng.trim() : '');
    ...
    try {
      ...
      if (placemarks.isNotEmpty) {
        ...
        final name = [place.subLocality, place.locality, place.country]
  ...
  String _ctRequestRadius(
    ...
    final key = '\$lat,\$lng';
    final placeName = (lat.isNotEmpty && lng.isNotEmpty && _ctPlaceNames.containsKey(key))
        ? _ctPlaceNames[key]
        : '';

    if ((placeName == null || placeName.isEmpty) && (lat.isEmpty || lng.isEmpty) && radius.isEmpty) return '-';
    ...
    if (lat.isNotEmpty && lng.isNotEmpty && radius.isNotEmpty) return '$lat, $lng - ${radius}km Radius';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                     Image.asset(menuIcon, width: 20.w, height: 20.h, color: appTextColor2),
                      SizedBox(width: 10.w),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Image.asset(handshakeIcon, width: 20.w, height: 20.h, color: appTextColor2),
                      SizedBox(width: 10.w),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Image.asset(peopleIcon, width: 20.w, height: 20.h, color: appTextColor2),
                      SizedBox(width: 10.w),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            SizedBox(height: 5.h),
                            AppText(
                              text: people == 0 ? '-' : people == 1 ? '1 Person' : '$people Persons',
                              size: 15,
                              fontWeight: FontWeight.w500,
                              color: appTextColor2,
                              lineSpacing: 1.5,
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Image.asset(calenderIcon, width: 20.w, height: 20.h, color: appTextColor2),
                      SizedBox(width: 10.w),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Image.asset(walletIcon, width: 20.w, height: 20.h, color: appTextColor2),
                      SizedBox(width: 10.w),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                     Image.asset(radiusIcon, width: 20.w, height: 20.h, color: appTextColor2),
                      SizedBox(width: 10.w),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Row(
                    children: [
                      Image.asset(searchBlackIcon, width: 15.w, height: 15.w),
                      SizedBox(width: 2.w),
                      GestureDetector(
                        onTap: () => setState(
