...
// Reuses _allResponses — in real app this would be a separate declined list
final List<ResponseModel> _allDeclinedResponses = [
  ResponseModel(
    couponId: "P17860",
...
List<ResponseModel> get _filteredDeclinedResponses {
  ...
  if (_declineFilter == "Today") {
    ...
    final String target = DateFormat('yyyy-MM-dd').format(_declineCustomDate!);
...
Widget _buildDeclineFilterOption(String label, {bool isCustom = false}) {
  final bool isSelected =
      isCustom ? _declineFilter == "Custom" : _declineFilter == label;
...
Widget _buildSearchFilterOption(String label, {bool isCustom = false}) {
  final bool isSelected =
      isCustom ? _searchFilter == "Custom" : _searchFilter == label;
...
final List<ResponseModel> _allResponses = [
  ResponseModel(
    couponId: "P17854",
    restaurantName: "Bollywood Restaurant",
    pricePerPerson: 950,
...
List<ResponseModel> get _filteredResponses {
  ...
  final DateTime compareDate =
      _responseFilter == "Today" ? DateTime.now() : _responseCustomDate!;
...
Widget _buildResponseFilterOption(String label, {bool isCustom = false}) {
  final bool isSelected =
      isCustom ? _responseFilter == "Custom" : _responseFilter == label;
          ...
          Padding(
            ...
            child: Row(
              children: [
                GestureDetector(
                  onTap: () =>
                      setState(() => viewDeclineOnClick = !viewDeclineOnClick),
                  child: Icon(
                    Icons.arrow_back_ios_new,
                    color: appTextColor3,
                    size: 28,
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 12.h),
                        AppText(
                          text: "No declined responses for $_declineFilterLabel",
                          size: 15,
                          fontWeight: FontWeight.w500,
                          color: appTextColor3,
                          isCentered: true,
