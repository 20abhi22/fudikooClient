...
class RestaurantCard extends StatefulWidget {
  ...
  final void Function(String? offerId)? onBoxClicked;
  final String uuid;
  final String name;
  final String type;
    ...
    if (response.status) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: AppText(
            text: isLiked ? 'Add to favourites' : 'Removed from favourites',
            size: 13,
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget.averageReview != null
                                        ? widget.averageReview!.toStringAsFixed(
                                            1,
                                          )
                                        : 'N/A',
                                    style: TextStyle(
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final days = offer.activeDays
                              ...
                              .map((d) => d.trim())
                              .toList();
                          final dateLabel = days.contains(today)
                              ? 'TODAY'
                              : days.first.toUpperCase();

                          return GestureDetector(
                            onTap: () => widget.onBoxClicked?.call(
                              offer.uuid,
                            ), // Pass offer ID on tap
                            child: Padding(
