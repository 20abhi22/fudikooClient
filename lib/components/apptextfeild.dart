...
class _AppTextFeildState extends State<AppTextFeild> {
  ...
  Widget build(BuildContext context) {
    final double resolvedSideIconSlotWidth =
        widget.sideIconSlotWidth ?? 24.w;

    final double resolvedSideSpacing =
        widget.sideSpacing ?? 12.w;
      ...
      child: Stack(
        children: [
                        ...
                        children: [
                          ...
                          widget.iconImagePath != null
                              ? Image.asset(
                                ...
                                width: 17.w,
                                height: 17.h,
                                color: widget.iconImagecolor??Color.fromARGB(255, 8, 8, 8),
                              )
                              : Icon(
                                widget.icon ??
                          ...
                          widget.secondIconImagePath != null
                              ? Image.asset(
                                ...
                                height: 17.h,
                                color:
                                    widget.secondIconImageColor??Color.fromARGB(255, 8, 8, 8),
                              )
                              : Icon(
                                widget.secondIcon ??
          ...
          if (widget.isRequired == true)
            Positioned(
              right:
                  widget.requiredRight ?? 10.w,

              top:
                  widget.requiredTop ?? 8.h,
